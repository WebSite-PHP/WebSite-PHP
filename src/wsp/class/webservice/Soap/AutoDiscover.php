 ...
 * @see Zend_Soap_Wsdl
 */
require_once 'wsp/class/webservice/Soap/Wsdl.php';
/**
 * @see Zend_Server_Reflection
 */
require_once 'wsp/class/webservice/Server/Reflection.php';
/**
 * @see Zend_Server_Abstract
 */
require_once 'wsp/class/webservice/Server/Abstract.php';
/**
 * @see Zend_Uri
 */
require_once 'wsp/class/webservice/Uri.php';
