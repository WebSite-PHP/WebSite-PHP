 ...
 */
require_once 'wsp/class/webservice/Soap/Server.php';

/**
 * @see Zend_Soap_Client_Local
 */
require_once 'wsp/class/webservice/Soap/Client/Local.php';

/**
 * @see Zend_Soap_Client_Common
 */
require_once 'wsp/class/webservice/Soap/Client/Common.php';
...
class Zend_Soap_Client
{
    ...
    public function __construct($wsdl = null, $options = null)
    {
        if (!extension_loaded('soap')) {
            require_once 'wsp/class/webservice/Soap/Client/Exception.php';
