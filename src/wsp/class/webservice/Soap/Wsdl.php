 ...
 */
require_once "wsp/class/webservice/Soap/Wsdl/Strategy/Interface.php";

/**
 * @see Zend_Soap_Wsdl_Strategy_Abstract
 */
require_once "wsp/class/webservice/Soap/Wsdl/Strategy/Abstract.php";
...
class Zend_Soap_Wsdl
{
    ...
    {
        if($strategy === true) {
            require_once "wsp/class/webservice/Soap/Wsdl/Strategy/DefaultComplexType.php";
            $strategy = new Zend_Soap_Wsdl_Strategy_DefaultComplexType();
        } else if($strategy === false) {
            require_once "wsp/class/webservice/Soap/Wsdl/Strategy/AnyType.php";
            $strategy = new Zend_Soap_Wsdl_Strategy_AnyType();
        } else if(is_string($strategy)) {
            if(class_exists($strategy)) {
                $strategy = new $strategy();
            } else {
                require_once "wsp/class/webservice/Soap/Wsdl/Exception.php";
