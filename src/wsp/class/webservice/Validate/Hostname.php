 ...
 */
require_once 'wsp/class/webservice/Validate/Abstract.php';

/**
 * @see Zend_Validate_Ip
 */
require_once 'wsp/class/webservice/Validate/Ip.php';

/**
 * Please note there are two standalone test scripts for testing IDN characters due to problems
 * with file encoding.
 *
 * The first is tests/wsp/class/webservice/Validate/HostnameTestStandalone.php which is designed to be run on
 * the command line.
 *
 * The second is tests/wsp/class/webservice/Validate/HostnameTestForm.php which is designed to be run via HTML
...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        ...
        'CN'  => 'Hostname/Cn.php',
        'COM' => 'wsp/class/webservice/Validate/Hostname/Com.php',
        ...
        'HK'  => 'wsp/class/webservice/Validate/Hostname/Cn.php',
        ...
        'JP'  => 'wsp/class/webservice/Validate/Hostname/Jp.php',
        ...
        'NET' => 'wsp/class/webservice/Validate/Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
        'NU'  => 'wsp/class/webservice/Validate/Hostname/Com.php',
        ...
        'TW'  => 'wsp/class/webservice/Validate/Hostname/Cn.php',
        ...
        '中国' => 'wsp/class/webservice/Validate/Hostname/Cn.php',
        '公司' => 'wsp/class/webservice/Validate/Hostname/Cn.php',
        '网络' => 'wsp/class/webservice/Validate/Hostname/Cn.php'
    );
