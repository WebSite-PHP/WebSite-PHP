 ...
 */
require_once 'wsp/class/webservice/Server/Reflection/Node.php';

/**
 * Zend_Server_Reflection_Parameter
 */
require_once 'wsp/class/webservice/Server/Reflection/Parameter.php';

/**
 * Zend_Server_Reflection_Prototype
 */
require_once 'wsp/class/webservice/Server/Reflection/Prototype.php';
...
abstract class Zend_Server_Reflection_Function_Abstract
{
    ...
    public function __construct(Reflector $r, $namespace = null, $argv = array())
    {
        ...
        if ((!$r instanceof ReflectionFunction)
            ...
            require_once 'wsp/class/webservice/Server/Reflection/Exception.php';
