...
require_once 'wsp/class/webservice/Server/Interface.php';

/**
 * Zend_Server_Definition
 */
require_once 'wsp/class/webservice/Server/Definition.php';

/**
 * Zend_Server_Method_Definition
 */
require_once 'wsp/class/webservice/Server/Method/Definition.php';

/**
 * Zend_Server_Method_Callback
 */
require_once 'wsp/class/webservice/Server/Method/Callback.php';

/**
 * Zend_Server_Method_Prototype
 */
require_once 'wsp/class/webservice/Server/Method/Prototype.php';

/**
 * Zend_Server_Method_Parameter
 */
require_once 'wsp/class/webservice/Server/Method/Parameter.php';
...
abstract class Zend_Server_Abstract implements Zend_Server_Interface
{
    ...
    protected function _buildSignature(Zend_Server_Reflection_Function_Abstract $reflection, $class = null)
    {
        ...
        if (!$this->_overwriteExistingMethods && $this->_table->hasMethod($method)) {
            require_once 'wsp/class/webservice/Server/Exception.php';
