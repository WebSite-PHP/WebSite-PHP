<?php
	...
	define("SEND_WAIT_MAIL_MESSAGE", "Dear %s,<br/><br/>Your message has been sent to %s.<br/>We will process your request as soon as possible.<br/><br/>Best regards,<br/>%s<br/>");
	...
	define("MAIL_SENT", "Message has been sent.");
